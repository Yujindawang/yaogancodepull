...
def generate_iamgets(dataset=None):
    ...
    if dataset  == 'DOTA':
        ...
        trainset = r'/media/luoxy/DATA1/DATA/HRSC2016/ImageSets/train.txt'
        valset   = r'/media/luoxy/DATA1/DATA/HRSC2016/ImageSets/val.txt'
        testset   = r'/media/luoxy/DATA1/DATA/HRSC2016/ImageSets/test.txt'
        img_dir = r'/media/luoxy/DATA1/DATA/HRSC2016/FullDataSet/AllImages'
        label_dir = r'/media/luoxy/DATA1/DATA/HRSC2016/FullDataSet/Annotations'
        root_dir = r'/home/luoxy/WORK/I-Star/DAL/NWPU_VHR' 
